...
class ReviewWriteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnSubmit = findViewById<Button>(R.id.next_button)
        tvCount = findViewById(R.id.tvCount)
        imageSlot = findViewById(R.id.imageSlot)
        ...
        etReview.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                tvCount.text = "${s?.length ?: 0}/1000"
                btnSubmit.isEnabled = !s.isNullOrBlank() && currentRating > 0
            }
